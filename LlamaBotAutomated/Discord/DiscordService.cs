...
using LlamaBotAutomated.Discord.Attributes;
using LlamaBotAutomated.Discord.Exceptions;
using LlamaBotAutomated.Discord.Extensions;
...
namespace LlamaBotAutomated.Discord
{
